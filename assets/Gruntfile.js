...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        uglify: {
            dist: {
                ...
                files: {'<%= config.dist %>/scripts/main.js': ['<%= config.dist %>/scripts/all.js','<%= config.app %>/scripts/main.js']}
            },
            release: {
                options: {
                    mangle: true //混淆变量名
    ...
    grunt.registerTask('build', 'start the build your app', function (target) {
        if (target === 'release') {
            grunt.task.run([
                'clean:dist',
                //'wiredep',
